...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/invasion/': RouteRecordInfo<'/invasion/', '/invasion', Record<never, never>, Record<never, never>>,
    '/invasion/atlas': RouteRecordInfo<'/invasion/atlas', '/invasion/atlas', Record<never, never>, Record<never, never>>,
