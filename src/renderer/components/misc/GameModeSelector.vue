<template>
    <div class="mode-select">
        <div
            class="mode-column"
            :style="{
                backgroundImage: `url('/src/renderer/assets/images/backgrounds/5.jpg')`,
            }"
            @click="
        ...
        <div
            class="mode-column"
            :style="{
                backgroundImage: `url('/src/renderer/assets/images/modes/raptors.jpg')`,
            }"
            @click="
        ...
        >
            <span>Raptors</span>
            <button class="quick-play-button">Be stronger than flesh</button>
        </div>
        <div
            class="mode-column"
            :style="{
                backgroundImage: `url('/src/renderer/assets/images/modes/scavengers.webp')`,
            }"
            @click="
        ...
        <div
            class="mode-column"
            :style="{
                backgroundImage: `url('/src/renderer/assets/images/modes/ffa.jpg')`,
            }"
            @click="
