<template>
    <div class="control-panel" v-if="settingsStore.devMode">
        <TresLeches />
    </div>
...
import OrbitControls from "@renderer/components/3d/OrbitControls.vue";
...
const ashMaterial = new THREE.ShaderMaterial({
  ...
  `,
  fragmentShader: // Your shader code here,
  transparent: true,
  blending: THREE.AdditiveBlending
});

// Update in animation loop
ashMaterial.uniforms.uTime.value += delta;
